...
- They make it easier to focus on hypothesis generation and testing [[1]](#peng2023). 
...
- They point toward a new workflow for computational science [[2]](#lu2024):
...
Literature review has also become easier. 
  ...
  - They are good at following the center of a topic, but less reliable for finding what sits at the edges: neglected ideas, strange exceptions, and papers outside the usual citation paths [[3]](#azamfirei2023).
