...
$$
\text { h(1) } x_a(1)+\sum_{b \neq a}\left[\int d x_2\left|x_b(2)\right|^2 r_{12}^{-1}\right] x_a(1)-\sum_{b \neq n}\left[\int d x_2 x_b^*(2) x_a(2) r_{12}^{-1}\right] x_b(1)=\varepsilon_a x_a(1)
$$

\begin{equation}
\left.h(1) x_a(1)+\left.\sum_{b \neq a}\left|\int d x_2\right| x_a(2)\right|^2 r_{12}^{-1}\right] x_a(1)-\sum_{b \neq n}\left[\int d x_2 x_b^*(2) x_a(2) r_{12}^{-1}\right] x_b(1)=\varepsilon_a x_a(1)
\end{equation}
